...
<!--ventana para delete--->
<div class="modal fade" id="editarCompra<?php echo $row["id_compra"]; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
      ...
      <div class="modal-body" id="cont_modal">
        <form action="../controladores/ControladorVenta.php" method="POST">
          ...
          <div class="form-group col-md-6">
              ...
              <input type="date" name="fecha_c" id= "fecha_c" class="form-control" value="<?php echo $row['fecha_c']; ?>" required="true" readonly>
            </div>
          ...
          <table class="table table-bordered text-center align-middle">
                    ...
                    <tbody>
                        <?php foreach (ControladorCompra::listarDet($row["id_compra"]) as $row): ?>
                            <tr>
