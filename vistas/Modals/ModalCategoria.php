...
<!-- Modal -->
<div class="modal modal-blur fade" id="mdCategoria" tabindex="-1" role="dialog" aria-hidden="true">
    <div class=" modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="titulo">Datos de la Categoria</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Cerrar">
                </button>
            </div>
            <form action="../controladores/ControladorCategoria.php" method="POST" name="form" id="form">
                <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-6">
                            <label for="usuario" class="col-form-label">Descripción</label>
