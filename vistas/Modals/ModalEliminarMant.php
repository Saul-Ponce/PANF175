...
<div class="modal fade" id="EliminarMant<?php echo $row["id_cmantenimiento"]; ?>" tabindex="-1" role="dialog" aria-labelledby="ModalLabel" aria-hidden="true" style="z-index: 1050;">
                    ...
                    <form id="MantForm" action="../controladores/ControladorMant.php" method="POST">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" id="detalles_m" name="detalles_m" value="<?php echo $row['detalles_m']; ?>" disabled>

                            </div>
                            <div class="col-md-6 mb-3">
                                <label for="fecha_m" class="form-label">Fecha de mantenimiento</label>
                                <input type="date" class="form-control" id="fecha_m" name="fecha_m" value="<?php echo $row['fecha_m']; ?>" disabled>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-4">
                                ...
                                <input type="text" oninput="formatMoneyInput(this)" class="form-control" id="precio_m" name="precio_m"value="<?php echo $row['precio_m']; ?>" disabled>
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="form-check-radio mt-4">
                                    <label class="form-check-label">
                                        <input class="form-check-input" type="radio" name="estado_m" id="exampleRadios1" value="Finalizado"  <?=$row['estado_m'] == 'Finalizado' ? 'checked' : ''?> disabled>
                                ...
                                <div class="form-check-radio">
                                    <label class="form-check-label">
                                        <input class="form-check-input" type="radio" name="estado_m" id="exampleRadios2" value="En proceso" <?=$row['estado_m'] == 'En proceso' ? 'checked' : ''?> disabled>
                                        <span class="form-check-sign"></span>
                                        En proceso
                                    </label>
                                </div>
