                        ...
                        <table class="table table-bordered text-center align-middle">
                            <thead>
                                <tr>
                                    ...
                                    <th style="font-size:13px !important;" scope="col">Dirección</th>
                                    <th style="font-size:13px !important;" scope="col">Teléfono</th>
                                    <th style="font-size:13px !important;" scope="col">Correo Electronico</th>
                                            ...
                                            <div class="d-flex justify-content-center">
                                                ...
                                                <?php if ($_SESSION['rol'] == "Administrador"): ?>
                                                    <button class="btn <?= $row["estado"] ? 'btn-danger' : 'btn-success' ?> me-2 "
                                                        ...
                                                        data-bs-toggle="modal" data-bs-target="#mdProveedor">
                                                        <?= $row["estado"] ? '<i class="fa fa-user-times" aria-hidden="true"></i>' :
                                                            '<i class="fa fa-user" aria-hidden="true"></i>' ?>
                                                    </button>
                                                    <button class="btn btn-danger " data-bs-toggle="modal"
                                                data-bs-target="#mdProveedor" onclick='eliminar(<?=json_encode($row)?>)'>
    ...
    <script>
        ...
        function cambiarEstado(data) {
            document.getElementById("titulo").innerHTML = data.estado == "1" ?
                '¿SEGURO QUE DESEA DAR DE BAJA A ESTE PROVEEDOR?' : '¿SEGURO QUE DESEA ACTIVAR A ESTE PROVEEDOR?';
        ...
        function eliminar(data) {
            document.getElementById("titulo").innerHTML = "¿SEGURO QUE DESEA BORRAR ESTE PROVEEDOR?";
