...
<div class="main-panel">
                ...
                <table class="table table-bordered text-center align-middle">
                    <thead>
                        <tr>
                            ...
                            <th style="font-weight: 700; font-size:16px; text-align: center!important;" scope="col">Cliente</th>
                    ...
                    <tbody>
                        <?php foreach (ControladorVenta::listar() as $row): ?>
                            <tr>
                                ...
                                <th>
                                    ...
                                    <button type="button" class="btn btn-warning mr-2" data-toggle="modal" data-target="#editarVenta<?php echo $row['id_venta']; ?>"><i class="fa-regular fa-pen-to-square"></i></button>
    ...
    <?php foreach (ControladorVenta::listar() as $row): ?>
        ...
        <?php include '../vistas/Modals/ModalEditarVenta.php';?>
    <?php endforeach;?>
